...
<script src="/rap_admin/addons/GIS/ganalytics/js/jquery.effects.core.js"></script>
<script src="/rap_admin/addons/GIS/ganalytics/js/jquery.effects.pulsate.js"></script>
...
<script type='text/javascript'>
	//+ load css/js stuff
	addCssLink('./addons/GIS/ganalytics/css/styles.css');

	var loadingimage = '<img src="addons/GIS/ganalytics//images/loader-small.gif" alt="" border="">';
	...
	<tr>
		<td valign=bottom>&nbsp;
			...
			<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">
				<b>Google Analytics - Flexible Google Analytics for RAP</b>
			</font></div>
		...
		?></div>
			...
			<div align="right">
				...
				<div class='clearfix'>
				&nbsp;<a href='addons/GIS/ganalytics/ganalytics_manual.pdf' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/ganalytics/images/document.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Analytics<br>Manual</div></div></a>&nbsp;
			&nbsp;<a href='http://askmikemyers.com' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/ganalytics/images/help_64.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Analytics Addon<br>Support</div></div></a>&nbsp;
			...
			<div class='gis-container-global'>
				<div class='gis-container-admin padding-rl-10'>
					<div class=gis-titlebar>
						<div class='subhead-big left'>Google Analytics Options</div>
						<div style='clear:both;'></div>
					</div>
					...
					<div class=gis-section id="global-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<span class='subheading-section left titles-big'>Global Options<br>
								
								<font style="font-size: 14px;"><i>Default for all products</i></font></span>
								<div style='clear:both;'></div>
							</div>
						</div>
						</a>
...
<div class="rounded-box-red">
        ...
        If you would like to set different options for each product, select a product then return here to set the individual product options.
    		</div> 
		</div>
...
//		var path	=	jQuery(this).parent().find('.path').html();
		...
		else
		{
			...
			jQuery.post("addons/GIS/ganalytics/global_options.php", {  },
					function(data){
						cont.html(data);
...
//		var fln = jQuery('#files').val();
		...
		else
		{
			cont.toggle();
			cont.html(loadingimage);
			jQuery.post("addons/GIS/ganalytics/product_options.php", { productID: prodid},
					function(data){
						cont.html(data);
