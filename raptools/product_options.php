...
<? if ($_POST['pid'] != "" && $_POST['savetag'] != "") {
	...
	if ($_POST['robots'] == '1')
		...
		gInsertOptionInt("AllowRobots", $_POST["pid"], '0');
		
	if ($_POST['sitemap'] == 1)
		gInsertOptionInt("SiteMap", $_POST["pid"], '1');
	else	
		gInsertOptionInt("SiteMap", $_POST["pid"], '0');

	if ($_POST['rss'] == 1)
		gInsertOptionInt("RSS", $_POST["pid"], '1');
	else
		gInsertOptionInt("RSS", $_POST["pid"], '0');

	if ($_POST['email_not'] == 1)
		gInsertOptionInt("EmailNotify", $_POST["pid"], '1');
	else
		gInsertOptionInt("EmailNotify", $_POST["pid"], '0');
...
<tr><td>
 ...
 <?
	 ...
	 $end_action = gGetOptionInt("EndAction", $pid, '0');
 ?>
