...
function aProductAdd() {
	...
	jQuery.post("addons/GIS/autooptin/edit_auto_prod.php", { action: 'new', productID: '<?= $productID;?>' },
					function(data){
...
function aEditProduct(uid) {
	...
	jQuery('#pr-opt-disp').html(loadingimage);
	jQuery.post("addons/GIS/autooptin/edit_auto_prod.php", { uid: uid, action: 'edit', productID: <?= $productID?> },
					function(data){
						jQuery('#pr-opt-disp').html(data);
				  	}
				);
...
function aToggleItem(uid, status, type) {
	...
	jQuery.post("addons/GIS/autooptin/product_options_edit.php", { uid: uid, action: 'toggle', status: status, productID: <?= $productID?> },
					function(data){
						jQuery('#pr-opt-disp').html(data);
				  	}
				);
...
function aDeleteProduct(uid) {
	...
	jQuery('#pr-opt-disp').html(loadingimage);
	jQuery.post("addons/GIS/autooptin/delete_entry_prod.php", { uid: uid, productID: <?= $productID?> },
					function(data){
						jQuery('#pr-opt-disp').html(data);
				  	}
				);
...
<?
	if ($_POST['action'] == "insert") {
        ...
        <br><font style="font-size: 14px;"><i>
        		New Auto Opt-in Record For The Current Product Has Been Inserted...
        		</i><br>&nbsp;
    		</div> 
		</div>
		<br>
...
<?	} else if ($_POST['action'] == "update") {
	...
	$gid=mysql_query($sql);
	?>
		<div class="rounded-box-green" id="message-box3">
        ...
        <br><font style="font-size: 14px;"><i>
        		Product Auto Opt-in Updated!</i><br>&nbsp;
    		</div> 
		</div>
		<br>
		<script type="text/javascript">
			jQuery('#message-box3').fadeOut(10000);
		</script>
<?
...
<?	}
 ?>
		...
		<table width="700">
<tr><td colspan="9" align="right" bgcolor="#dac8b6"><a href="javascript:aProductAdd();"><img src="addons/GIS/autooptin/images/add48x48.png" border="0"></a></td></tr>
<tr><td>&nbsp;</td></tr>
...
<?
	...
	if ( mysql_num_rows($gid) < 1 ) {
        ...
        <br><font style=\"font-size: 14px;\"><i>No Auto Opt-in Entries were found for This Product.  Click the add button above to add one.
        		</i><br>&nbsp;
		...
		while ($grow = mysql_fetch_array($gid)) {
			...
			<tr class="Prompts"><td><?= $grow['Name']; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td align="left"<?= $stsbg;?>><a href="#" onClick="<?= $toggleaction;?>"><img src="<?=$imgpth;?>" border="0" width="24" height="24"></a><?= $ststxt; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td><a href="javascript:aEditProduct('<?= $grow['uid']; ?>')"><img src="addons/GIS/autooptin/images/edit32x32.png" border="0"></a>&nbsp;&nbsp;<a href="javascript:aDeleteProduct('<?= $grow['uid']; ?>')"><img src="addons/GIS/autooptin/images/delete32x32.png" border="0"></a>&nbsp;</td>
  			</tr>
<? 			}
	} ?>  
  <tr><td>
