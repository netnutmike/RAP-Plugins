...
if ($_REQUEST['action'] == "register") { ?>
	...
	<form id="registrationform" name="registrationform" method="post" action="/rap_admin/addons/GIS/raptools/ClassVersion.php">
	<input type="hidden" name="action" value="registration">
	<input type="hidden" name="title" value="<?= $_REQUEST['title']; ?>">
	<table width="500">
	<tr><td>&nbsp;</td></tr>
	<tr><td class="Prompts" colspan="3">Before you can use the Rap Tools addon you need to register it using the paypal email address you used when you purchased the addon.<br><br>Enter in the email address in the field below and click the Register button.</td></tr>
	<tr><td>&nbsp;</td></tr>
	...
	function versioninfo()
	{
		...
		if ($reg == '0') { 
			...
			$html="
				...
				<iframe src='addons/GIS/raptools/ClassVersion.php?action=register&title=" . $title . "' width='800' height='800' frameborder='0'>
