...
<? 	} else if ($_POST['action'] == "Update" ) {
	...
	$sql = "UPDATE g_addToCart set Name='" . $_POST['Name'] . "', productID='" . $_POST['productID'] . "', regularPrice='" . $_POST['regularPrice'] . "', endDate='" . $_POST['endDate'] . "', endAction='" . $_POST['endAction'] . "', status='" . $_POST['status'] .  "', template='" . $_POST['template'] . "', soldoutTemplate='" . $_POST['soldoutTemplate'] . "', CopiesLeftText='" . $_POST['CopiesLeftText'] . "' where uid='" . $_POST['uid'] . "'";
	$gid=mysql_query($sql);
	?>
		<div class="rounded-box-green" id="message-box">
    	    <div class="box-contents">
