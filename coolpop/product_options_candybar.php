...
if ($_POST['action'] == "Update" ) {
	...
	$sql = "UPDATE g_CoolPop set offerText='" . $_POST['offerText'] . "', initialDelay='" . $_POST['initialDelay'] . "', height='" . $_POST['height'] . 
...
function aSaveatc() {
	...
	jQuery.post("addons/GIS/coolpop/product_options_candybar.php", { offerText: offerText, initialDelay: initialDelay, height: height, 
...
<?
	...
	if (mysql_num_rows($gid) == 0) {
		$sql="insert into g_CoolPop (productID, offerText, Status) VALUES ('" . $_POST['productID'] . "', 'Your code for the Slide-up ad Goes Here.  It can include HTML, images, etc', '0')";
		$gid=mysql_query($sql);
		$sql="select * from g_CoolPop where productID='" . $_POST['productID'] . "'";
		$gid=mysql_query($sql);
	}
