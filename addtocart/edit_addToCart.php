...
function aSave(uid) {
	...
	var MoneySymbol = jQuery('#MoneySymbol').val();
	var SlashDirection = jQuery('#SlashDirection').val();
	var SlashColor = jQuery('#SlashColor').val();
	var RegularColor = jQuery('#RegularColor').val();
	var TodayColor = jQuery('#TodayColor').val();

	jQuery('#pr-opt-disp').html(loadingimage);
	
	jQuery.post("addons/GIS/addtocart/product_options.php", { Name: Name, regularPrice: regularPrice, endDate: endDate,  status: status, endAction: end_action, template: template, soldoutTemplate: soldoutTemplate, CopiesLeftText: CopiesLeftText, uid: uid, MoneySymbol: MoneySymbol, SlashDirection: SlashDirection, SlashColor: SlashColor, RegularColor: RegularColor, TodayColor: TodayColor, action: "Update", productID: "<?= $_REQUEST['productID']; ?>" },
					function(data){
						jQuery('#pr-opt-disp').html(data);
				  	}
				);
...
?>
 	...
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Money Symbol:</td><td>&nbsp;&nbsp;</td><td><input type="text" name="MoneySymbol" id="MoneySymbol" value="<?= $grow['MoneySymbol'];?>"></td><td>(Defaults to: "$")</td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Strike-thru Direction:</td><td></td></td><td colspan="2"><select name="SlashDirection" id="SlashDirection">
 	<option value="1" <?php if ($grow['SlashDirection'] == 1) echo "SELECTED"?>>Bottom Left to Top Right</option>
 	<option value="2" <?php if ($grow['SlashDirection'] == 2) echo "SELECTED"?>>Top Left to Bottom Right</option>
 	<option value="3" <?php if ($grow['SlashDirection'] == 3) echo "SELECTED"?>>Horizontal Center</option>

</select></td></tr>
 	
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Strike-thru Color:</td><td>&nbsp;&nbsp;</td><td><input type="text" name="SlashColor" id="SlashColor" value="<?= $grow['SlashColor'];?>"></td><td>Red/Green/Blue (Defaults to: "255/29/0")</td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Price Line Color:</td><td>&nbsp;&nbsp;</td><td><input type="text" name="RegularColor" id="RegularColor" value="<?= $grow['RegularColor'];?>"></td><td>Red/Green/Blue (Defaults to: "33/29/132")</td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Copies Color:</td><td>&nbsp;&nbsp;</td><td><input type="text" name="TodayColor" id="TodayColor" value="<?= $grow['TodayColor'];?>"></td><td>Red/Green/Blue (Defaults to: "33/29/132")</td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td colspan="4">
 		<ul class="checklist">
						<li>
