...
<script type='text/javascript'>
	//+ load css/js stuff
	addCssLink('./addons/GIS/candybar/css/styles.css');

	var loadingimage = '<img src="addons/GIS/candybar//images/loading.gif" alt="" border="">';
	//window.onload = myPageLoad;
</script>

<script type="text/javascript" src="addons/GIS/candybar/js/jquery.lavalamp.min.js"></script>
<script type="text/javascript" src="addons/GIS/candybar/js/jquery.easing.min.js"></script>
<script type="text/javascript" src="addons/GIS/candybar/js/tiny_mce.js"></script>
	...
	<tr>
		<td valign=bottom>&nbsp;
			...
			<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">
				<b>Candy Bar for RAP - Slide Up Ads for RAP.</b>
			</font><a href="http://www.rapusersgroup.com" target="_blank"><img src="addons/GIS/candybar/images/rap-users-group-button.jpg" height="30" width="126" border="0" align="right"></a>&nbsp;
		<a href="http://www.rap-tutorials.com" target="_blank"><img src="addons/GIS/candybar/images/rap-tutorials-button.png" height="30" width="126" border="0" align="right"></a>&nbsp;</div>
		...
		?></div>
			...
			<div align="right">
				...
				<div class='clearfix'>
				&nbsp;<a href='addons/GIS/candybar/candybar_manual.pdf' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/candybar/images/document.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Candy Bar<br>Manual</div></div></a>&nbsp;
			&nbsp;<a href='http://askmikemyers.com' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/candybar/images/help_64.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Candy Bar Addon<br>Support</div></div></a>&nbsp;
					...
					<div class=gis-section id="product-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<span class='subheading-section left titles-big'>Candy Bar Settings<br>
...
<div class="rounded-box-red">
        ...
        <br><font style="font-size: 14px;"><i>To set the Candy Bar options you must first select a product from the Select Product Menu.</i><br>&nbsp;
    		</div> 
		</div>
		<? } ?>
...
jQuery(document).ready(function(){
	...
	jQuery("a.product").click(function() {
		...
		else
		{
			...
			jQuery.post("addons/GIS/candybar/product_options.php", { productID: "<?= $productID; ?>"},
					function(data){
						cont.html(data);
