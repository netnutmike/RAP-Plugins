...
<script type='text/javascript'>
	//+ load css/js stuff
	addCssLink('./addons/GIS/popover/css/styles.css');

	var loadingimage = '<img src="addons/GIS/popover//images/loading.gif" alt="" border="">';
	//window.onload = myPageLoad;
</script>

<script type="text/javascript" src="addons/GIS/popover/js/jquery.lavalamp.min.js"></script>
<script type="text/javascript" src="addons/GIS/popover/js/jquery.easing.min.js"></script>
<script type="text/javascript" src="addons/GIS/popover/js/tiny_mce.js"></script>
	...
	<tr>
		<td valign=bottom>&nbsp;
			...
			<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">
				<b>Pop-Over - Add a Pop-over window to your RAP product.</b>
			</font></div>
		...
		?></div>
			...
			<div align="right">
				...
				<div class='clearfix'>
				&nbsp;<a href='addons/GIS/popover/popover_manual.pdf' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/popover/images/document.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Pop-Over<br>Manual</div></div></a>&nbsp;
			&nbsp;<a href='http://askmikemyers.com' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/popover/images/help_64.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Pop-Over Addon<br>Support</div></div></a>&nbsp;
					...
					<div class=gis-section id="product-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<span class='subheading-section left titles-big'>Pop-Over Settings<br>
...
<div class="rounded-box-red">
        ...
        <br><font style="font-size: 14px;"><i>To set the Pop-Over options you must first select a product from the Select Product Menu.</i><br>&nbsp;
    		</div> 
		</div>
		<? } ?>
					<!-- Global Option -->
					<div class=gis-section id="global-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<font style="font-size: 14px;"><i>for All Products</i></font></span>
								<div style='clear:both;'></div>
...
jQuery(document).ready(function(){
	...
	jQuery("a.product").click(function() {
		...
		else
		{
			...
			jQuery.post("addons/GIS/popover/product_options.php", { productID: "<?= $productID; ?>"},
					function(data){
						cont.html(data);
