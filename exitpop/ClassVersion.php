...
if ($_REQUEST['action'] == "register") { ?>
	...
	<table width="500">
	<tr><td>&nbsp;</td></tr>
	<tr><td class="Prompts" colspan="3">Before you can use the Editor addon you need to register it using the paypal email address you used when you purchased the addon.<br><br>Enter in the email address in the field below and click the Register button.</td></tr>
	<tr><td>&nbsp;</td></tr>
