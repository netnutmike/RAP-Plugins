...
$title="Exit-Ramp";
$description="Easy Exit Pops in RAP";
...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<tr ><td colspan=2><font style="font-size: 18px;" color="gray" face=tahoma >Creating Exit-Ramp Tables...
		<?php
			...
			$querystr = "CREATE TABLE IF NOT EXISTS `g_ExitRamp` (
