...
<script type='text/javascript'>
	//+ load css/js stuff
	addCssLink('./addons/GIS/exitramp/css/styles.css');

	var loadingimage = '<img src="addons/GIS/exitramp//images/loading.gif" alt="" border="">';
	//window.onload = myPageLoad;
</script>

<script type="text/javascript" src="addons/GIS/exitramp/js/jquery.lavalamp.min.js"></script>
<script type="text/javascript" src="addons/GIS/exitramp/js/jquery.easing.min.js"></script>
<script type="text/javascript" src="addons/GIS/exitramp/js/tiny_mce.js"></script>
	...
	<tr>
		<td valign=bottom>&nbsp;
			...
			<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">
				<b>Exit-Ramp for RAP - Add a Pop-over window to your RAP product.</b>
		...
		<a href="http://www.rap-tutorials.com" target="_blank"><img src="addons/GIS/editor/images/rap-tutorials-button.png" height="30" width="126" border="0" align="right"></a>&nbsp;</div>
		...
		?></div>
			...
			<div align="right">
				...
				<div class='clearfix'>
				&nbsp;<a href='addons/GIS/exitramp/exitramp_manual.pdf' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/exitramp/images/document.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Exit-Ramp<br>Manual</div></div></a>&nbsp;
			&nbsp;<a href='http://askmikemyers.com' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/exitramp/images/help_64.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">Exit-Ramp Addon<br>Support</div></div></a>&nbsp;
					...
					<div class=gis-section id="product-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<span class='subheading-section left titles-big'>Exit-Ramp Settings<br>
...
<div class="rounded-box-red">
        ...
        <br><font style="font-size: 14px;"><i>To set the Exit-Ramp options you must first select a product from the Select Product Menu.</i><br>&nbsp;
    		</div> 
		</div>
		<? } ?>
...
jQuery(document).ready(function(){
	...
	jQuery("a.product").click(function() {
		...
		else
		{
			...
			jQuery.post("addons/GIS/exitramp/product_options.php", { productID: "<?= $productID; ?>"},
					function(data){
						cont.html(data);
