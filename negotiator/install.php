...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<tr align=center><td colspan=2><h2>Creating Theme Options Table:
		<?php
			...
			$querystr = "Create table if not exists g_themeOptions (uid int auto_increment, productid int, template varchar(25), timeType int, time varchar(14), status int, primary key(uid))";
