...
|
| ================================================================
| RAP-tools.com AutoResponder for RAP
| ================================================================
+--------------------------------------------------------------------------
*/
...
<script type='text/javascript'>
	//+ load css/js stuff
	addCssLink('./addons/GIS/autoresponder/css/styles.css');

	var loadingimage = '<img src="addons/GIS/autoresponder//images/loading.gif" alt="" border="">';
	...
	<tr>
		<td valign=bottom>&nbsp;
			...
			<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">
				<b>AutoResponder - Advanced Auto-Responders For RAP</b>
			</font></div>
		...
		?></div>
			...
			<div align="right">
				...
				<div class='clearfix'>
				&nbsp;<a href='addons/GIS/autoresponder/autoresponder_manual.pdf' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/autoresponder/images/document.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">AutoResponder<br>Manual</div></div></a>&nbsp;
			&nbsp;<a href='http://askmikemyers.com' target='_blank'><div class='right' style='height: 65px; maring-left: 15px; width: 65px; background: transparent url(addons/GIS/autoresponder/images/help_64.png) no-repeat;'>&nbsp;</div><div class=right><div class="georgia-big">AutoResponder Addon<br>Support</div></div></a>&nbsp;
			...
			<div class='gis-container-global'>
				<div class='gis-container-admin padding-rl-10'>
					<div class=gis-titlebar>
						<div class='subhead-big left'>AutoResponder Options</div>
						<div style='clear:both;'></div>
					</div>
					...
					<div class=gis-section id="global-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<div><span class='subheading-section left titles-big'>Global AutoResponder Options<br>
					...
					<div class=gis-section id="product-options">
						...
						<div class=gis-buttons>
							<div class='buttons'>
								...
								<span class='subheading-section left titles-big'>Product AutoResponder Options<br>
...
//		var path	=	jQuery(this).parent().find('.path').html();
	...
	jQuery("a.product").click(function() {
		...
		else
		{
			cont.toggle();
			cont.html(loadingimage);
			jQuery.post("addons/GIS/autoresponder/product_options_edit.php", { productID: prodid},
					function(data){
						cont.html(data);
