...
// Connect to mysql server
	...
	<table width="500">
	<tr><td>&nbsp;</td></tr>
	<tr><td class="Prompts" colspan="3">Before you can use the the Themes addon you need to register it using your paypal email address.  The site owners paypal email will be used for registration.</td></tr>
	<tr><td>&nbsp;</td></tr>
