...
function aSaveNew() {
	...
	jQuery.post("addons/GIS/themes/global_options_edit.php", { type: '1', action: 'insert', time: time, template: template },
					function(data){
						jQuery('#gl-opt-disp-set').html(data);
				  	}
				);
...
function aSave(uid) {
	...
	jQuery.post("addons/GIS/themes/global_options_edit.php", { type: '1', action: 'update', time: time, template: template, uid: uid, status: status },
					function(data){
						jQuery('#gl-opt-disp-set').html(data);
				  	}
				);
