...
$title="Theme Engine";
$description="Easy Theme Automation for RAP";
...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<tr ><td colspan=2><font style="font-size: 18px;" color="gray" face=tahoma >Creating Themes Tables...
		<?php
			...
			$querystr = "Create table if not exists g_themeOptions (uid int auto_increment, productid int, template varchar(25), timeType int, time varchar(14), status int, options text, primary key(uid))";
