...
<tr><td colspan="2"><br><font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">Global Advanced Options:</font><br>&nbsp;</td></tr>
 	...
 	<tr><td class="Prompts">Header:</td><td colspan="2"><textarea name="gex7" id="gex7" cols="45" rows="7"><?= trim($g_gflds[6]) ?></textarea></td></tr>
 	<tr><td class="Prompts">Footer:</td><td colspan="2"><textarea name="gex8" id="gex8" cols="45" rows="7"><?= trim($g_gflds[7]) ?></textarea></td></tr>
 	<tr><td>&nbsp;</td></tr>
 	...
 	<tr><td class="Prompts">Header:</td><td colspan="2"><textarea name="pex7" id="pex7" cols="45" rows="7"><?= trim($g_pflds[6]) ?></textarea></td></tr>
 	<tr><td class="Prompts">Footer:</td><td colspan="2"><textarea name="pex8" id="pex8" cols="45" rows="7"><?= trim($g_pflds[7]) ?></textarea></td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td>&nbsp;</td></tr>
