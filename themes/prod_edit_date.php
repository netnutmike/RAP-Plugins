...
function aSaveCancel(pid) {
	...
	jQuery.post("addons/GIS/themes/product_options_edit.php", { type: '2', pid: pid },
					function(data){
...
function aSaveNew(pid) {
	...
	jQuery.post("addons/GIS/themes/product_options_edit.php", { type: '2', action: 'insert', time: time, template: template, pid: pid },
					function(data){
						jQuery('#pr-opt-disp-set').html(data);
				  	}
				);
...
function aSave(uid, pid) {
	...
	jQuery.post("addons/GIS/themes/product_options_edit.php", { type: '2', action: 'update', time: time, template: template, uid: uid, status: status, pid: pid },
					function(data){
						jQuery('#pr-opt-disp-set').html(data);
				  	}
				);
...
<tr><td>
 	...
 	<? if ($_POST['action'] == "edit") {?>
 		...
 		<tr><td>&nbsp;</td></tr>
 	<? } ?>
 	<tr><td class="Prompts">Event Type:</td><td></td></tr>
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts">Date / Time:</td><td colspan="2"<input type="text" name="time" id="time" value="<?= $timeval ?>" size="16"></td></tr>
 	<tr><td>&nbsp;</td></tr>
