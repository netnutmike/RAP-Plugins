...
//==============================================================================================
	...
	$imagepath = $basepath . "/rap_admin/addons/GIS/themes/themes/" . $_POST['tmpname'] . "/preview.jpg";
	
	if (file_exists($imagepath)) {
		echo "<img src=\"/rap_admin/addons/GIS/themes/themes/" . $_POST['tmpname'] . "/preview.jpg\" width=\"450\" height=\"450\">";
	}
