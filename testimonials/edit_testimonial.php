...
<input type="image" src="/rap_admin/addons/GIS/testimonials/images/save.png" value="Save" onClick="javascript:aSave('<?= $grow['uid'];?>');"/> Save
</td><td align="right">
<input type="image" src="/rap_admin/addons/GIS/testimonials/images/delete.png" onClick="javascript:aSaveCancel();" /> Cancel
</td></tr></table>
</td></tr></table>
