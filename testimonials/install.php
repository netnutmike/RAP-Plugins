...
$title="Testimonials";
$description="Easily Manage Your Testimonials from within RAP";
...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<tr ><td colspan=2><font style="font-size: 18px;" color="gray" face=tahoma >Creating Testimonial Tables...
		<?php
			...
			$querystr = "Create table if not exists g_testimonials (uid int auto_increment, productID int, Date varchar(10), Time varchar(8), Name varchar(200), VisualName varchar(200), FromLocation varchar(200), Email varchar(250), Status int, ShortSubject varchar(50), Testimonial text, LastUsed varchar(15), UsageVar int, UseWhere varchar(50), VideoURL text, primary key(uid))";
			@mysql_query($querystr);
			
			$querystr = "Create table if not exists g_testimonialOptions (uid int auto_increment, productID int, Template varchar(25), CSSOption int, primary key(uid))";
			@mysql_query($querystr);
		...
		<tr><td><div class="rounded-box-green" id="message-box">
    	    <div class="box-contents">
        		<br><font style="font-size: 18px;"><strong><?=$title?> Installed!</strong></font><img src="/rap_admin/addons/GIS/testimonials/images/info48x48.png" align="right">
