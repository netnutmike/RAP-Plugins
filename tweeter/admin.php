			...
			<div class='gis-container-global'>
				<div class='gis-container-admin padding-rl-10'>
					...
					<div class=gis-section id="global-options">
						...
						<div class='gis-content padding-rl-20' id="gl-opt-disp"><font size="3" color="black" face=tahoma >There are no adminsitrative options to setup for the Tell-A-Friend addon.  This page is here so you have access to the latest version information, the manual and support.<br><br>There are 2 tokens that need to be inserted into your template files.<br><br>
						<strong>gTAFHeader()</strong> - This token needs to be inserted in between the &lt;head&gt; and &lt;/head&gt; tags in the header.html template.  It would look like this: &lt;? gTAFHeader(); ?&gt;<br><br><strong>gTAFBody()</strong> - This token needs to be inserted just before the &lt;/body&gt; HTML tag.  It looks like this: &lt;? gTAFBody(); ?&gt;.</font></div>
					</div>
