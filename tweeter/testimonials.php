...
<?	}
		...
		<table>
<tr><td colspan="9" align="right"><a href="javascript:aAdd();" onmouseover="Tip('Click this icon to add a new Testimonial')" onmouseout="UnTip()"><img src="addons/GIS/testimonials/images/add32x32.png" border="0"></a></td></tr>
...
<?
	...
	if ( mysql_num_rows($gid) < 1 ) {
		...
		while ($grow = mysql_fetch_array($gid)) { 
			...
			<tr class="Prompts"><td><?= $grow['ShortSubject']; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td><?= $grow['VisualName']; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td align="center"<?= $stsbg;?>><?= $ststxt; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td align="center"><?= $grow['UseWhere']; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td align="center"><?= $grow['uid']; ?></td><td>&nbsp;&nbsp;&nbsp;</td><td><a href="javascript:aEdit('<?= $grow['uid']; ?>')" onmouseover="Tip('Click this icon to edit this testimonial')" onmouseout="UnTip()"><img src="addons/GIS/testimonials/images/edit32x32.png" border="0"></a>&nbsp;&nbsp;<a href="javascript:aDelete('<?= $grow['uid']; ?>')"  onmouseover="Tip('Click this icon to delete this Testimonial')" onmouseout="UnTip()"><img src="addons/GIS/testimonials/images/delete32x32.png" border="0"></a>&nbsp;</td>
  			</tr>
<? 			}
	} ?>  
  <tr><td>
