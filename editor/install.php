...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<?php
			...
			@mysql_query($querystr);
			$querystr = "insert into template_files (filename, description, pid) VALUES ('affiliates.html','This template is shown to a customer interested in your affiliate program.  It should be Selling them on promoting your products.','1234')";
			@mysql_query($querystr);
