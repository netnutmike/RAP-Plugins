...
// Connect to mysql server
	...
	<form id="registrationform" name="registrationform" method="post" action="/rap_admin/addons/GIS/editor/ClassVersion.php">
	<input type="hidden" name="action" value="registration">
	<input type="hidden" name="title" value="<?= $_REQUEST['title']; ?>">
	<table width="500">
	<tr><td>&nbsp;</td></tr>
	<tr><td class="Prompts" colspan="3">Before you can use the the Editor addon you need to register it using your paypal email address.  The site owners paypal email will be used for registration.</td></tr>
	<tr><td>&nbsp;</td></tr>
...
if ($_REQUEST['action'] == "registration") {
	...
	if ($success == '1') {
		echo "<p class=\"Prompts\">Congratulations this addon is now registered for this domain.  Click the continue link below to return to the main RAP interface.<br><br><a href=\"/rap_admin\" target=\"_top\">Continue...</a></p>";
	} else {
...
class ModVersion
{
	function versioninfo($g_emailaddr)
	{
		...
		if ($reg == '0') { 
			...
			$html="
				...
				<iframe src='addons/GIS/editor/ClassVersion.php?action=register&title=" . $title . "' width='800' height='800' frameborder='0'>
	...
	{
		global $sys_version, $g_emailaddr;
		$title = title;
