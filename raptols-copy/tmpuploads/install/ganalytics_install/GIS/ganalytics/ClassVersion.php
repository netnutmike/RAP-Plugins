...
class ModVersion
{
	function versioninfo()
	{
		...
		$upgrade = (version < $latestversion) ? "<a target=_blank href=$upgradeURL><font color=Red>Download Current Release.</font></a> <br>(<a href=\"http://www.rap-tools.com/index.php?option=com_content&view=article&id=11:gfrap-releases&catid=10:gafrap\" target=\"_blank\"><font color=green>view release notes</font></a>)" : "<font color=green>You have the latest version.</font>" ;
