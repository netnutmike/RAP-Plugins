...
if ($_POST['action'] == "Update" ) {
	...
	$sql = "UPDATE g_Clickbank set orderLink='" . $_POST['orderLink'] . "', hopLink='" . $_POST['hopLink'] . "', status='" . $_POST['status'] . "' where productID='" . $_POST['productID'] . "' AND entryType='1'";
	$gid=mysql_query($sql);
...
function aSaveatc() {
	...
	jQuery.post("addons/GIS/clickbank/product_options.php", { orderLink: orderLink, hopLink: hopLink, status: status, action: "Update", productID: "<?= $_REQUEST['productID']; ?>" },
					function(data){
...
<tr><td>
 	...
 	<tr><td>&nbsp;</td></tr>
 	<tr><td class="Prompts" >Clickbank Order Hoplink:</td><td>&nbsp;&nbsp;</td><td><input type="text" name="hopLink" id="hopLink" size="35" value="<?= $grow['hopLink'];?>">
 	<input type="hidden" name="status" id="status" size="35" value="<?= $grow['status'];?>"></td></tr>
 	<tr><td>&nbsp;</td></tr>
 	 		<script type="text/javascript">
    jQuery(function() { jQuery(".lavaLamp").lavaLamp({ fx: "backout", speed: 700 })});
</script>
 	<tr><td colspan="4">
 		<font size="4" color="gray" face=tahoma style="letter-spacing: -1px;">Clickbank Type:</font>
	<ul class="lavaLamp">
            <li id="li1"><a href="#" onClick="javascript:aOptionPage('0')">Off</a></li>
            <li id="li2"><a href="#" onClick="javascript:aOptionPage('1')">Optional</a></li>
            <li id="li3"><a href="#" onClick="javascript:aOptionPage('2')">Full Time</a></li>
 ...
 <!-- 	<tr><td colspan="4">
 		<ul class="checklist">
						<li>
                    		...
                    		<label for="status">Clickbank Only Product</label>
