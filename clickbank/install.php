...
<td align=center>
	<table align=center cellpadding=3 cellspacing=0>
		...
		<?php
			...
			$querystr = "Create table if not exists g_Clickbank (uid int auto_increment, productID int, entryType int, status int, orderLink varchar(250), hopLink varchar(250), primary key(uid))";
